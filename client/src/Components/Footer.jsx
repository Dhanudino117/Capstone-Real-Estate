      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div  className="">
          ...
          <ul className="mt-3 space-y-2 text-gray-600">
            <Link to='/' className="cursor-pointer hover:text-black">Home</Link> <br />
            <Link to='/about' className="cursor-pointer hover:text-black">About Us</Link> <br />
            <Link to='/testimonials' className="cursor-pointer hover:text-black">Testimonials</Link><br />
            <Link to='/contact' className="cursor-pointer hover:text-black">Contacts</Link>
          </ul>
        </div>
